/**    
 * IbatisSearchRepositoryImpl.java
 * Create on 2010-7-7
...
public class IbatisDAOImpl extends SqlMapClientDaoSupport implements IbatisDAO {
	 ...
	 * @return Long,记录数
	 */
	public Long findIbatisListCount(String querySqlName,
			Map<String, Object> paramsMap) throws DataAccessException {
		return (Long) getSqlMapClientTemplate().queryForObject(querySqlName,
				paramsMap);
	}
	 ...
	 * @return int,影响记录数
	 */
	public Object insertIbatisObject(String insertSqlName,
			Map<String, Object> paramsMap) throws DataAccessException {
	 ...
	 * @return int,影响记录数
	 */
	public int updateIbatisObject(String updateSqlName,
			Map<String, Object> paramsMap) throws DataAccessException {
	 ...
	 * @return int,影响记录数
	 */
	public int deleteIbatisObject(String deleteSqlName,
			Map<String, Object> paramsMap) throws DataAccessException {
	 ...
	 *            ,参数列表
	 */
	public void batchInsertIbatisObject(final String insertSqlName,
			final List<Map<String, Object>> paramsMapList) throws Exception {
	...
	public void batchUpdateIbatisObject(final String updateSqlName,
			final List<Map<String, Object>> paramsMapList) throws Exception {
		SqlMapClientCallback callback = new SqlMapClientCallback() {
			public Object doInSqlMapClient(SqlMapExecutor executor)
					throws SQLException {
	...
	public <T> T queryForObject(Class<T> entityClass, String statementId,
			Object parameters) {
		return (T) getSqlMapClientTemplate().queryForObject(statementId,
				parameters);
	}

	public <T> List<T> queryForList(Class<T> entityClass, String statementId,
			Map<String, Object> params) {
		return (List<T>) getSqlMapClientTemplate().queryForList(statementId,
				params);
	}
