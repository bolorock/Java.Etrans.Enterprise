 ...
 */
	...
	public Boolean getIsShowHandle() {
		return isShowHandle;
	}

	public void setIsShowHandle(Boolean isShowHandle) {
	...
	private String workUnitFullId;

	public void setWorkUnitFullId(String workUnitFullId) {
		this.workUnitFullId = workUnitFullId;
	}
	...
	public Map getParamsOrFullid(Map params){
		...
		if(workUnitID == null){
			...
			params.put("wuID", workUnitID);//单位id
			return params;
		}		
