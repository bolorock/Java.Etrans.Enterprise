...
public class UserContext {
	 ...
	 * @param user
	 */
	public static void setAlarmDel(Map<String, String> alarmStr)
	{
		Struts2Utils.setSessionArrtibute(Constants.ALARMDEL, alarmStr);
	}
	
//	/**
//	 * 保存回复【处理】 上级查岗，报警督办信息 map【没用了的】
//	 * @param cgordb 
//	 */
//	public static void setCgOrDb(Map<String, String> cgordb){
//		Struts2Utils.setSessionArrtibute(Constants.CGORDB, cgordb);
//	}
