...
/**
 * @author dasuan
 * @category Ibatis业务层(接口)
 */
public interface IbatisServices {
	...
	public <T> List<T> queryForList(Class<T> entityClass, String statementId, Map<String, Object> params);
