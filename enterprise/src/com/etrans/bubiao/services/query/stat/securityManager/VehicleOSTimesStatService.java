 ...
 */
@Service
public class VehicleOSTimesStatService {
	...
	public PageBean getVehicleOSTimesStatList(Map setParamsMap) throws Exception{
		...
		try {
			...
			/**执行查询**/
    		rows= this.ibatisServices.queryForList(Map.class, "getVehicleOSTimesStatSQL",setParamsMap);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public  List<Map<String, Object>>  getVehicleOSTimesStatListExportExl(Map setParamsMap,String fromPage,String toPage) throws Exception{
...
//	    setParamsMap.put("@workunitid",String.valueOf(sessionUser.getWorkUnitID()));
		...
		List<Map<String,Object>> rows = this.ibatisServices.queryForList(Map.
				class, "getVehicleOSTimesStatSQL",setParamsMap);
		return rows;
