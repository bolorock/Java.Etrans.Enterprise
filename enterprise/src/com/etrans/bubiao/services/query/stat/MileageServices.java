...
public class MileageServices {
	...
	/**
	 * 成本管理-里程统计
	 * @param setParamsMap，sessionUser
	 * @return pageBean
	 * @throws Exception
	 */

	@SuppressWarnings("unchecked")
	public PageBean getMileageInfo(Map setParamsMap, SessionUser sessionUser)
			throws Exception {
		...
		try {
			...
			rows = this.ibatisServices.queryForList(Map.class,
					"getMileageInfoSQL", setParamsMap);
	 ...
	 */
	@SuppressWarnings( { "unchecked" })
	public List<Map<String, Object>> getMileageInfoExl(Map setParamsMap,
...
//		setParamsMap.put("@workunitid", String.valueOf(sessionUser.getWorkUnitID()));
		...
		List<Map<String, Object>> rows = this.ibatisServices.queryForList(
				Map.class, "getMileageInfoSQL", setParamsMap);
		return rows;
