...
private static final long serialVersionUID = 1L;
	...
	public void historyAlarmHandlingList() {
		try {
			...
			LogUtil.insertLog(LogActionTypes.READ, "成功", "历史报警督办", "", "历史报警督办");
		} catch (Exception e) {
			LogUtil.insertLog(LogActionTypes.READ, "失败", "历史报警督办", "", "历史报警督办");
			e.printStackTrace();
	...
	public void exporthistoryAlarmHandling(){
		...
		try {
			...
			LogUtil.insertLog(LogActionTypes.READ, "成功", "历史报警督办导出", "", "历史报警督办导出");
		} catch (Exception e) {
			LogUtil.insertLog(LogActionTypes.READ, "失败", "历史报警督办导出", "", "历史报警督办导出");
			e.printStackTrace();
		}
	}
