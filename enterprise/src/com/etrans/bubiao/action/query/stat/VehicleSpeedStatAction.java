...
public class VehicleSpeedStatAction extends BaseAction {
/**  描述  */    
   ...
   private Map<String, Object> params=null;
	...
	public VehicleSpeedStatAction(){
//		super();
		super.excelTplFile="车辆速度统计";
	}
	
	@Action(value = "findVehicleSpeedList")
	public void findVehicleSpeedList(){
		try {
    ...
    protected void doFillWorkbook(Workbook wb) {
    	try {
    		...
    		List<Map<String, Object>> vehicleModels = vehicleSpeedStatService.getVehicleSpeedExportExl(params, user, fromPage, toPage);
    		 String [] titleArray={"registrationNo","WeekAveSpeed","MonthAveSpeed","YearAveSpeed","WeekAveSpeed_oWeek","WeekNumber","DayAveSpeed_oMonth",
...
//    					List<Object> tempList = new ArrayList<Object>();
	 ...
	 @Action(value = "VehicleSpeedListExportExl", results = @Result(type = "stream", params = { "contentType", "application/vnd.ms-excel",
