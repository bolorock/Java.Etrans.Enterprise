...
@Controller("eTGetVehicleGpsLocationAction")
@Scope("prototype")
...
//			   System.out.println("lng:"+pointMap.get("lng")+"lat:"+pointMap.get("lat"));
	...
	/**
	 *http://localhost:80/enterprise/httpMobile/ETGetTrackBack.action?jsonParam={"userID":"51","ticket":"1358835197986-5021","lon":"23.111","lat":"113.3434"}
	 *1.6.10	获取单车辆轨迹回放数据接口
	 */
	@SuppressWarnings("unused")
	@Action(value = "ETGetTrackBack2")
	public void ETGetTrackBack2() throws Exception 
	{
