...
function hideShowTable(obj){
	...
	if(obj.valueFlag==0){
		...
		obj.valueFlag=1;
		$("#tableDiv").css("height", "380");
		$("#title",window.parent.document).hide();
	}else{
		obj.src=baseP+"imgs/up_btn.gif";
		obj.valueFlag=0;
		$("#map").css("display","block");
		$("#tableDiv").css("height", "55");
		$("#title",window.parent.document).show();
...
<%--						<input type="button" id="" class="btn_map" onClick="showRegistrationVhicleTree();" value="请选择"/>--%>
                      ...
                      <td>开始：
									<input type="text" id="beginTime" name="beginTime" class="inputnone" size="16" onFocus="WdatePicker({firstDayOfWeek:1,isShowWeek:true,el:document.getElementById('beginTime'),dateFmt:'yyyy-M-d H:m:s',maxDate:'%y-%M-%d'})" />
                      ...
                      <td>结束：
									<input type="text" id="endTime" name="endTime" class="inputnone" size="16" onFocus="WdatePicker({firstDayOfWeek:1,isShowWeek:true,el:document.getElementById('endTime'),dateFmt:'yyyy-M-d H:m:s',maxDate:'%y-%M-%d'})" />
					   ...
					   <td>
							<a id="btnSetting" href="javascript:openSettting()">高级设置</a>		
					   </td>
...
<%-- 								  <input type="button"  class="btn_map" onClick="backMonitor('<%=basePath%>');" value="返回监控"/> 	 --%>
			...
			<div id="showData" style="display: block;">
		   	<table id="tbTrack" width="100%" border="0" cellspacing="0" cellpadding="0" class="mon_t_infor">
             	<tr class="mon_t_01">
             		<td class="m_t" nowrap="nowrap" width="5%">编号</td>
		   	...
		   	<div id="tableDiv" style="overflow-x: scroll; overflow-y: scroll; height:55px; width: 100%;">
 ...
 <div id="divSetting" class="dd" >
 	<table>
	 	<tr>
		 	<td>
		 		<label style="font-weight:bold;">播放设置</label>
		 	</td>
	 	</tr>
	 	<tr>
		 	<td style="padding-left:20px;">
		 		回放速度： <select id="playRate" name="playRate">
	 	...
	 	<tr>
	 		<td>
	 			<label style="font-weight:bold;">轨迹过滤设置</label>
	 		</td>
	 	</tr>
	 	<tr>
	 		<td style="padding-left:20px;">
	 			<label class="checkbox"> <input id="chkStatus" type="checkbox">显示状态</label>
	 		</td>
	 	</tr>
	 	<tr>
	 		<td style="padding-left:20px;">
	 			<label class="checkbox"> <input id="chkStop" type="checkbox" checked="checked">合并停车轨迹点</label>
	 		</td>
	 	</tr>
	 	<tr>
	 		<td style="padding-left:20px;">
	 			<label class="checkbox"> <input id="chkSpeed" type="checkbox" checked="checked">合并速度<5km/h</label>
	 		</td>
	 	</tr>
	 	<tr>
	 		<td>
	 	...
	 	<tr>
	 		<td style="padding-left:20px;">
	 			<label class="checkbox"> <input id="chkLocation" type="checkbox">自动显示所有位置信息</label>
	 		</td>
	 	</tr>
	 	
 	</table>
 </div>
 <form id="ddform" name="ddform" method="post">
 </form>
  <script type="text/javascript">
