...
<script src="<%=basePath%>js/command/batch/batchCommand.js" type="text/javascript"></script>
<script src="<%=basePath%>js/command/batch/batchBuCommand.js" type="text/javascript"></script>
