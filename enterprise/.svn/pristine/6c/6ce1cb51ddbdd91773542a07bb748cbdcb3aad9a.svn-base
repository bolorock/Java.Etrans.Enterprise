...
<script type="text/javascript" src="${basePath}js/analyse/analyseRoadExcursion.js"></script>
				   ...
				   <tr>
				      ...
				      <td width="200">
				       	<input type="text" name="name" id="name" class="td_input" maxlength="20"
				      			...
				      			ajaxAction="analyse/checkName4Form.action?tableName=ANA_AnalyserRoadExcursion" 
								ajaxDataId="id">
...
<!--				          <a id="reSetBtn" href="javascript:void(0)" class="ser_btn" style="margin-bottom: 3px;">重置</a><br/>-->
				...
				<!--第二行-->
			     ...
			     <td align="right" class="td_te"> <span class="xin_red">*</span>时间门限(秒) ：</td>
			       <td><input type="text" name="bounceTime" id="bounceTime" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
			    ...
			    <tr>
				 ...
				 <tr>
			 	  <td align="right" class="td_te"> <span class="xin_red">*</span>范围门限(米) ：</td>
			 	   <td><input type="text" name="minExcursionValue" id="minExcursionValue" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
								>
					  <span id="minExcursionValuespan" class="errorMsg" style="display: none"></span>
					</td>
				 </tr>
