        	...
        	<div class="E_Tit">行驶里程统计</div>
        	   <table border="0" cellspacing="0" cellpadding="0" class="que_tab">
	              <tr>
	                ...
	                <td width="120" align="left"><input id="registrationNO" name="registrationNO" type="text" class="mon_ser_text"
	                                              style="width: 130;"
	                                              maxlength="30"
	                ...
	                <td width="170" align="left">
	                <input type="text" id="endDate" name="endDate" class="mon_ser_text" style="width: 120px" onFocus="this.blur()" readonly="readonly" value="<%=DateFormatUtils.format(new Date(), "yyyy-MM-dd HH:mm:ss") %>" />
						<img src="Images/time.jpg" width="20" height="23" style="margin-left:2px;"
