...
<script type="text/javascript" src="${basePath}js/analyse/analyserDriverOverTime.js"></script>
...
<div style="width: 100%" id="cont_box">
	<div class="main">
		<div class="mon_cont">
			<div class="E_Tit">司机疲劳驾驶报警设置</div>
				   ...
				   <tr>
				      ...
				      <td width="200">
				       	<input type="text" name="name" id="name" class="td_input" maxlength="20"
				      			...
				      			ajaxAction="analyse/checkName4Form.action?tableName=ANA_AnalyserDriverOverTime" 
								ajaxDataId="id">
