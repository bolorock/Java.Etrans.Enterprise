...
<head>
<script type="text/javascript"	src="${basePath}js/sys/tree/vehicleSimTree.js"></script>	
...
<body style="background-color: #fff;overflow: hidden">
 ...
 <div id="simTree"  style="background-color:#FFFAFA;WIDTH: 365; HEIGHT: 260;overflow-x: hidden; OVERFLOW: scroll;" ></div>
