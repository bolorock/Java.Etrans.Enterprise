...
$(function() {
		...
		$("#findVehicleSpeedSactionList").datagrid( {
			url : 'query/stat/findVehicleSpeedSactionList.action',
//			dataType : 'json',
		...
		var p = $('#findVehicleSpeedSactionList').datagrid('getPager');  
...
function toExportExl() {
	var options= $('#findVehicleSpeedSactionList').datagrid('options');
...
//	var registrationNo =$("#registrationNo").val();
	...
	exportExlEasyui('findVehicleSpeedSactionList', 'query/stat/VehicleSpeedSactionListExportExl.action?workUnitName='+workUnitName+'&year='+year+
			'&month='+month+'&day='+day+'&week='+week+'&page='+page+'&rows='+rows+'&isSection='+isSection);
