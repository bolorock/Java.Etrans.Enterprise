...
<link href="<%=basePath%>css/body.css" rel="stylesheet" type="text/css"/>
  ...
  <frameset cols="250,*"  frameborder="NO" border="0" framespacing="0">
	<frame src="<%=basePath%>analyse/authorityLeftMenu.jsp" name="leftFrame" id="leftFrame"  noresize="noresize" marginwidth="0" marginheight="0" frameborder="0" style="height:100%;width:100%" scrolling="no" />
