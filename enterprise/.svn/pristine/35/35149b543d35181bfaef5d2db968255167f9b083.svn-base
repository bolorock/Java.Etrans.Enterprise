...
<html>
<head>
        <title>企业车辆超速行驶统计</title>
        <script  type="text/javascript" src="${basePath}js/datepicker/WdatePicker.js"></script>
        <%--页面抽取js--%>
	    <script type="text/javascript" src="${basePath}js/query/stat/securityManager/workUnitOSTimesStat.js"></script>
		<%--时间帮助js--%>
...
<div id="cont_box">
	<div class="main">
        <div class="mon_cont">
        	<div class="E_Tit">企业车辆超速行驶统计</div>
...
<!--		             <a id="showBtn" href="javascript:void(0)" class="ser_btn" style="color: white;">图表</a>-->
		  ...
		  <%--列表--%>
          <div id="findWorkUnitOSTimesStat">
               <table id="findWorkUnitOSTimesStatList" style="display: none"></table>
          </div> 
