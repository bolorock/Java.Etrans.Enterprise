...
<html>
	<head>
		<title>路线偏移设置</title>
		<script type="text/javascript" src="${basePath}js/monitorCenter/lineAlarmConfig/lineAwayConfigList.js"></script>
	...
	<div class="main">
        <div class="mon_cont">
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="que_tab">
				<tr>
					...
					<td width="100">
						...
						<auth:authorize operation="createLineAwayConfig">
			...
			<div id="editWindow" class="wDiv" style="width:100%;display: none;border: 1px solid #d0d0d0;height:320px;overflow-y:auto;">
				<div class="td_title">路线偏移设置新增</div>
				<table width="100%" align="center">
					<tr>
						...
						<td width="160" align="left">
							<input type="text"
								...
								ajaxAction="monitorCenter/checkLineAwayName.action"
								ajaxActionError="已存在此名称，请重新输入！" />
							<span id="namespan" class="errorMsg" style="display: none"></span>
						</td>
						<td width="150" align="right"><span class="xin_red">*</span>允许偏离值(米)：</td>
						<td width="160" align="left">
							<input type="text"  
								class="td_input" maxlength="8"
								 formCheck="true" 
						  	     required="true" requiredError="必须输入项!" 
							     onlyNumber="true" onlyNumberError="请输入数字!"
								id="allowMaxAway" name="allowMaxAway" />
							<span id="allowMaxAwayspan" class="errorMsg" style="display: none"></span>
						</td>
					...
					<tr>
						<td width="150" align="right"><span class="xin_red">*</span>选择路线：</td>
						  <td width="160" align="left">
					         <select id="lineId" name="lineId" style="width: 179px"
							      formCheck="true" 
							      required="true" 
							      requiredError="必须输入项!"  
							      noselect="true" 
					        ...
					        <span id="lineIdspan" class="errorMsg" style="display: none"></span>
						  </td>
			...
			<div id="viewWindow" style="width:100%;display: none;border: 1px solid #d0d0d0;height:320px;overflow-y:auto;">
				<div class="td_title">路线偏移设置详情</div>
				<table width="100%" align="center">
					<tr>
					...
					<tr>
						<td width="150" align="right">允许偏离值(米)：</td>
						<td width="160" align="left">
							<input type="text" class="td_input" id="allowMaxAwayView" name="allowMaxAwayView" readonly="readonly"/>
						</td>
			...
			<table id="lineAwayConfigList" style="display: none"></table>
		</div> 
    </div>
	</div>
