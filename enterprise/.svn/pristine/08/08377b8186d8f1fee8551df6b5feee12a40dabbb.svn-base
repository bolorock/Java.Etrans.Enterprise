...
<head>
        <title></title>
        <script type="text/javascript" src="${basePath}js/analyse/driving/analyseMileagePerDay.js"></script>
	...
	<div class="main">
        <div class="mon_cont" id="gridBox">
        	<div class="E_Tit">每日里程记录报表</div>
             ...
             <div><table id="analyseMileagePerDayList" style="display: none"></table></div> 
