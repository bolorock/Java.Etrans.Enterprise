...
<script type="text/javascript" src="${basePath}js/analyse/analyseSpeed.js"></script>
				   ...
				   <tr>
				      ...
				      <td width="200">
				       	<input type="text" name="name" id="name" class="td_input" maxlength="20"
				      			...
				      			ajaxAction="analyse/checkName4Form.action?tableName=ANA_AnalyserSpeed" 
								ajaxDataId="id">
...
<!--				          <a id="reSetBtn" href="javascript:void(0)" class="ser_btn" style="margin-bottom: 3px;">重置</a><br/>-->
				...
				<!--第二行-->
				 <tr>
			 	  <td align="right" class="td_te"> <span class="xin_red">*</span>是否报警 ：</td>
					...
					<td align="right" class="td_te">是否蜂鸣报警 ：</td>
					<td><select id="isWarn" class="td_sel" name="isWarn" > </select></td>
			  ...
			  <!--第五行-->
			    <tr>
			      ...
			      <td>
			    	 <select id="isMoreThan" class="td_sel" name="isMoreThan" ></select>
			      </td>
			      <td align="right" class="td_te"><span class="xin_red">*</span>速度(KM/H) ：</td>
			      <td>
			      	<input type="text" name="bounceSpeed" id="bounceSpeed" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
			    ...
			    <!--第六行-->
			    <tr>
			      <td align="right" class="td_te"><span class="xin_red">*</span>时段(分) ：</td>
			      <td width="200">
			     ...
			     <tr>
			      ...
			      <td width="200">
			        <input type="text" name="soundContent" id="soundContent" class="td_input" width="250" maxlength="100">
			      </td>
			     </tr>
				</table>
			</div>
