...
<script type="text/javascript" src="${basePath}js/analyse/analyserRunAlarm.js"></script>
      		...
      		<div id="editWindow" class="wDiv" style="display:none;border: 1px solid #d0d0d0;width: 100%;height:300px;overflow-y:auto;">
				...
				<!--第二行-->
				 <tr>
			      ...
			      <td align="right" class="td_te"><span class="xin_red">*</span>运行距离(米) ：</td>
			      <td width="200">
			      	<input type="text" name="bounceRunDistance" id="bounceRunDistance" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
				      			textLength="1-8" valLengthError="长度为8位" 
								>
								<span id="bounceRunDistancespan" class="errorMsg" style="display: none"></span>
			      </td>
				 </tr>
				<!--第三行-->
			    <tr>
