...
<script type="text/javascript" src="${basePath}js/analyse/analyserInOutPlaceReport.js"></script>
      		...
      		<div id="editWindow" class="wDiv" style="display:none;border: 1px solid #d0d0d0;width: 100%;height:300px;overflow-y:auto;">
				   ...
				   <tr>
				      ...
				      <td width="200">
				       	...
				       	<input type="text" name="name" id="name" class="td_input" maxlength="20"
				      			...
				      			ajaxAction="analyse/checkInOutPolyByName.action" 
								ajaxDataId="id">
			    ...
			    <tr>
			     <td align="right" class="td_te"><span class="xin_red">*</span>时间门限(秒) ：</td>
			      <td width="200">
			      		<input type="text" name="bounceTime" id="bounceTime" class="td_input" maxlength="8"
				      			formCheck="true"
				      			integer="true" integerError="请输入有效整数!"
				      			required="true" requiredError="必须输入项" 
				      			textLength="1-8" valLengthError="长度为8位"  
								>
								<span id="bounceTimespan" class="errorMsg" style="display: none"></span>
			      </td>
			      <td align="right" class="td_te"><span class="xin_red">*</span>地点范围(米) ：</td>
			      <td width="200">
			      	<input type="text" name="bounceDistance" id="bounceDistance" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
				      			textLength="1-8" valLengthError="长度为8位" 
								>
								<span id="bounceDistancespan" class="errorMsg" style="display: none"></span>
			      </td>
