...
<script type="text/javascript" src="${basePath}js/analyse/analyseOverTimePark.js"></script>
				   ...
				   <tr>
				      ...
				      <td width="200">
				       	<input type="text" name="name" id="name" class="td_input" maxlength="20"
				      			...
				      			ajaxAction="analyse/checkName4Form.action?tableName=ANA_AnalyserOverTimePark" 
								ajaxDataId="id">
...
<!--				          <a id="reSetBtn" href="javascript:void(0)" class="ser_btn" style="margin-bottom: 3px;">重置</a><br/>-->
				...
				<!--第二行-->
				 <tr>
			 	  <td align="right" class="td_te"> <span class="xin_red">*</span>是否报警 ：</td>
					...
					<td align="right" class="td_te"><span class="xin_red">*</span>检测间隔(秒) ：</td>
			      <td width="120" colspan="3">
			        <input type="text" name="checkInterval" id="checkInterval" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
								>
					<span id="checkIntervalspan" class="errorMsg" style="display: none"></span>
			      </td>
				 </tr>
				<!--第三行-->
			    <tr>
			  ...
			  <!--第五行-->
			    <tr>
			      <td align="right" class="td_te"><span class="xin_red">*</span>分析方式   ：</td>
			      <td>
			    	 <select id="isPlaceInAlarm" class="td_sel" name="isPlaceInAlarm" ></select>
			      </td>
			      <td align="right" class="td_te"><span class="xin_red">*</span>地点组 ：</td>
			      <td>
			      	<select id="placeTypeId" class="td_sel" name="placeTypeId" formCheck="true" required="true" noselect="true" requiredError="请选择一项"> </select>
			 	            <span id="placeTypeIdspan" class="errorMsg" style="display: none"></span>
			 	            </td>
			     </tr>
			     
			    <!--第六行-->
			    <tr>
			      <td align="right" class="td_te"><span class="xin_red">*</span>最大停车时间(秒) ：</td>
			      <td width="200">
			      	<input type="text" name="bounceParkTimeDay" id="bounceParkTimeDay" class="td_input" maxlength="20"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
								>
								<span id="bounceParkTimeDayspan" class="errorMsg" style="display: none"></span>
			      </td>
			       <td align="right" class="td_te"><span class="xin_red">*</span>点范围门限 ：</td>
			      <td width="200">
			        <input type="text" name="bounceParkDistance" id="bounceParkDistance" class="td_input" maxlength="20"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
								>
								<span id="bounceParkDistancespan" class="errorMsg" style="display: none"></span>
			      </td>
			     </tr>
