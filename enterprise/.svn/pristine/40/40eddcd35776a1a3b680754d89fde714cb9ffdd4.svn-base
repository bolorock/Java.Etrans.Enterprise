...
<script type="text/javascript" src="${basePath}js/analyse/analyseMileagePerDay.js"></script>
				   ...
				   <tr>
				      ...
				      <td width="200">
				       	<input type="text" name="name" id="name" class="td_input" maxlength="20"
				      			...
				      			ajaxAction="analyse/checkName4Form.action?tableName=ANA_AnalyserMileagePerDay" 
								ajaxDataId="id">
