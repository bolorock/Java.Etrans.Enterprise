...
<head>
        ...
        <title>企业车辆在线率统计</title>
        <script  type="text/javascript" src="${basePath}js/datepicker/WdatePicker.js"></script>
	    <script type="text/javascript" src="${basePath}js/query/stat/workUnitOnlineStat.js"></script>
...
<%--		             <a style="display: none;" id="adSearchBtn" href="javascript:void(0)"   style="margin-left:8px;">高级搜索</a></td>--%>
          ...
          <div id="workUnitOnlineStat"><table id="workUnitOnlineStatList" style="display: none"></table></div> 
          <div id="workUnitOnlineStatListChart" style="display: none;width: 1020px; height: 345px; border: 1px outset #EEEEEE; padding-top: 2px; overflow-y: scroll; overflow-x: scroll;"></div> 
    </div>
</div>
</div>
