...
$(function() {
	 ...
	 initWeek2Date("slBeginWeek");
	   ...
	   $("#findWorkUnitOilInfoList").datagrid( {
			url : 'query/stat/findWorkUnitOilInfo.action',
		...
		var p = $('#findWorkUnitOilInfoList').datagrid('getPager');  
	    $(p).pagination({  
	        pageNumber: 1,
...
function toExportExl() {
	var options = $("#findWorkUnitOilInfoList").datagrid('options');
	...
	exportExlEasyui('findWorkUnitOilInfoList', 'query/stat/WorkUnitOilExportExl.action?workUnitName='+workUnitName+'&year='+year+
