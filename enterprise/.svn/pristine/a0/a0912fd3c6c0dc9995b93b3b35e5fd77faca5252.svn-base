...
<html>
<head>
        <title>车辆疲劳驾驶统计s</title>
        <script  type="text/javascript" src="${basePath}js/datepicker/WdatePicker.js"></script>
        <%--页面抽取js--%>
	    <script type="text/javascript" src="${basePath}js/query/stat/securityManager/vehicleDOTTimesStat.js"></script>
		<%--时间帮助js--%>
