...
<html>
	<head>
		...
		<script src="<%=basePath%>js/command/batch/special/510.js" type="text/javascript"></script>
	</head>
	 ...
	 <table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
			  <td width="100%" align="center">
				   <fieldset style="border-Color:#80CAEA;width: 98%;"><legend>设置电话本：指令参数</legend>
                          ...
                          <option value="0">删除电话本</option>
                    	 </select>
                    	  </td></tr>
                    	   <tr>
                   <td width="60px" id="eventCountId">联系人总数</td>
