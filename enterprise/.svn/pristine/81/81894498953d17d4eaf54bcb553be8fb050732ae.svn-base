...
<head>
        ...
        <title>车辆上传有效统计</title>
         <script type="text/javascript" src="${basePath}js/datepicker/WdatePicker.js"></script>
	    <script type="text/javascript" src="${basePath}js/query/stat/VehicleEffectiveUpload.js"></script>
...
<div id="cont_box">
	<div class="main">
        <div class="mon_cont">
          ...
          <div >
               <table id="findVehicleEffectiveUploadList" style="display: none"></table>
          </div> 
      </div>
</div>
</div>
