...
try{getVehicleChecked();}catch(e){}//取值
return false;
}).bind("mousedown.tree",function(){
return false;
});
...
var _167=$("<div class=\"panel-header\"><div class=\"panel-title\" style=\"cursor: move;margin-left:5px;text-align:left;\">"+opts.title+"</div></div>").prependTo(_166);
if(opts.iconCls){
