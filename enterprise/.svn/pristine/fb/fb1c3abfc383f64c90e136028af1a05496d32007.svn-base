...
<head>
        <title></title>
        <script type="text/javascript" src="${basePath}js/analyse/driving/drivingDOTGZSJW.js"></script>
	...
	<div class="main">
        <div class="mon_cont" id="gridBox">
        	<div class="E_Tit">疲劳驾驶报警(交委)</div>
             ...
             <div><table id="drivingDOTGZSJWList" style="display: none"></table></div> 
