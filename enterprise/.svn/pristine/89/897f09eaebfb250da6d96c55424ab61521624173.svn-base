...
//设置文本框可编辑
function doNoEdit(){
	$("#CommNO").attr("disabled",true);	
	$("#TerminalKindID").attr("disabled",true);
	$("#submitBtn").attr("disabled",true);
	$("#reSetBtn").attr("disabled",true);
	$("#cancelBtn").attr("disabled",true);
	$("#BatchNO").attr("disabled",true);
	$("#PlatformTerminalID").attr("disabled",true);
    $("#ManufacturerTerminalID").attr("disabled",true);
    $("#Model_Type").attr("disabled",true);
    $("#SimID").attr("disabled",true);
    $("#SignCode").attr("disabled",true);
    $("#UseFlag").attr("disabled",true);
    $("#workUnitIDName").attr("disabled",true);
}
