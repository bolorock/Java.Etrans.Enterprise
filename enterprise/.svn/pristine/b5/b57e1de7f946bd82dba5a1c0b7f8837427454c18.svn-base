...
<html>
<head>
        <title>企业车辆里程统计</title>
	    <script type="text/javascript" src="${basePath}js/query/stat/workUnitMileageInfo.js"></script>
...
<div id="cont_box">
	<div class="main">
        <div class="mon_cont">
          ...
          <div>
               <table id="findWorkUnitMileageInfoList" style="display: none"></table>
          </div> 
      </div>
</div>
</div>
