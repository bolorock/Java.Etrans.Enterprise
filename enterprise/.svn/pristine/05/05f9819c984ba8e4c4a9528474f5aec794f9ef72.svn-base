       ...
       <table border="0" cellspacing="0" cellpadding="0" class="que_tab">
				<tr>
				 <td  width="80" align="right">车牌号码：</td>
	                ...
	                <td width="170" align="left"><input id="endDate"  type="text" class="mon_ser_text" style="width:130px" onFocus="this.blur()" readonly="readonly" value="<%=DateFormatUtils.format(new Date(), "yyyy-MM-dd HH:mm:ss") %>" />
	                 <img src="Images/time.jpg" width="20" height="23" style="margin-left:2px;"
					...
					<td  width="80" align="right">所属单位：</td>
				 	<td width="120" align="left">
				 	<input type="text" id="workunitName" name="workunitName" class="mon_ser_text"
				 	       onchange="value=value.replace(/[^0-9a-zA-Z\u4e00-\u9fa5]/g,'')" 
						   onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^0-9a-zA-Z\u4e00-\u9fa5]/g,''))" />
				    </td>
				<!--&nbsp;&nbsp;&nbsp;&nbsp;-->
				 ...
				 <select id="alarmTypeSelect" class="ser_sel" style="width:120px">
				  </select>
				 </td>
				 <td  width="80" align="right">报警来源：</td>
				 <td width="150" align="left">
				 <select id="sourceSelect" class="ser_sel" style="width:120px">
				  </select>
				 </td>	
