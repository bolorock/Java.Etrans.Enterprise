	...
	<base href="<%=basePath%>"></base>
		...
		<link href="<%=basePath%>css/command.css" type="text/css" rel="stylesheet" />
		 ...
		 <script type="text/javascript">
			...
			function getParam()
			{
				return {"wrongQuestion":$("#wrongQuestion").val()};
			}
	 ...
	 <table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
			  <td width="100%" align="center">
				   <fieldset style="border-Color:#80CAEA;width: 98%;"><legend>主链路断开通知:指令参数</legend>
				  		<table width="100%" cellpadding="0" cellspacing="1">
				            <tr>
				              ...
				              <td width="181"><table width="100%" border="0" cellspacing="0" cellpadding="0">
				               ...
				               <tr>
				                  <td nowrap="nowrap"><div align="right">错误问题：</div></td>
				                  <td>
				                  		<select id="wrongQuestion" name="wrongQuestion">
				                  			<option value="0">主链路断开</option>
