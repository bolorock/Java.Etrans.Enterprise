...
<head>
        <title></title>
        <script type="text/javascript" src="${basePath}js/analyse/driving/drivingRoadExcursion.js"></script>
	...
	<div class="main">
        <div class="mon_cont" id="gridBox">
        	<div class="E_Tit">路段偏离报表</div>
             ...
             <div><table id="drivingRoadExcursionList" style="display: none"></table></div> 
