...
<html>
	<head>
		...
		<script type="text/javascript" src="${basePath}js/monitorCenter/lineAlarmConfig/lineQuotaConfigList.js"></script>
	...
	<div class="main">
        <div class="mon_cont">
        	<div class="E_Tit">路段限速设置</div>
        	<div id="search">
                <table  border="0" cellspacing="0" cellpadding="0"
					class="que_tab">
					<tr>
						<td width="50" align="right">名称：</td>
						<td width="150" align="left"><input id="lineName" name="lineName" type="text"
							    style="width: 130px;"
								maxlength="50"
						...
						<auth:authorize operation="lineQuota_add">
						<td width="60">
        	 ...
        	 <div id="editWindow" class="wDiv" style="width:100%;display: none;border: 1px solid #d0d0d0;height:320px;overflow-y:auto;">
				<div class="td_title">路段限速设置新增</div>
				<form id="addForm" class="formular"  method="post" action="">
				<table align="center">
				<tr>
			      <td width="150" align="right"><span class="xin_red">*</span>线路设置名称：</td>
			      <td width="160" align="left">
			      <input type="text" id="lineNameTxt" name="lineNameTxt"  maxlength="20" 
			       formCheck="true" required="true" requiredError="请输入名称！" 
			       noSpecialCaracters="true" noSpecialCaractersError="请输入中英文或数字！"
			       ajaxAction="monitorCenter/checkLineName.action" 
			       ajaxActionError="已存在此名称，请重新输入！"/>
			       <span id="lineNameTxtspan" class="errorMsg" style="display: none"></span>
			      </td>
			      <td width="150" align="right"><span class="xin_red">*</span>速度上限(km/h)：</td>
			      <td width="160" align="left">
			      		<input type="text" id="maxSpeed" maxlength="8"  name="maxSpeed" 
			      		 formCheck="true" 
				  	     required="true" requiredError="必须输入项!" 
					     onlyNumber="true" onlyNumberError="请输入数字!"
			      		 />
			      		<span id="maxSpeedspan" class="errorMsg" style="display: none"></span>
			       </td>
			     ...
			     <tr>
			      <td width="150" align="right"><span class="xin_red">*</span>选择线路：</td>
				  <td width="160" align="left">
			         <select id="lineIdSel" name="lineIdSel" style="width: 157px"
					      formCheck="true" 
					      required="true" 
					      requiredError="必须输入项!"  
					      noselect="true" 
			        ...
			        <span id="lineIdSelspan" class="errorMsg" style="display: none"></span>
				  </td>
		 ...
		 <div id="viewWindow" style="width:100%;display: none;border: 1px solid #d0d0d0;height:320px;overflow-y:auto;">
		      <div class="td_title">路段限速详情</div>
		          <table width="100%" align="center">
					...
					<tr>
						<td width="150" align="right">速度上线(km/h)：</td>
						<td width="160" align="left">
							<input type="text" class="td_input" id="maxSpeedView" name="maxSpeedView" readonly="readonly"/>
						</td>
          ...
          <table id="lineQuotaConfigList" style="display: none"></table>
    </div>
</div>
</div>
	</body>
