...
<html>
  ...
  <script type="text/javascript" src="<%=basePath%>js/jq/jquery-1.7.1.min.js"></script>
   <script type="text/javascript" src="<%=basePath%>js/datepicker/WdatePicker.js"></script>
	...
	<script type="text/javascript" src="<%=basePath%>js/monitorCenter/higherLevelMessage2.js"></script>
...
<%--查岗和督办的每条记录接收时间【用作处理过后过滤数据】--%>
  <input type="hidden" id="getTimeCaGang">
  <input type="hidden" id="getTimeDuBan"> 
  </body>
</html>
