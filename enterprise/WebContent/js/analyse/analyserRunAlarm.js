...
//表名
var tableName = "ANA_AnalyserRunAlarm";
//编辑权限
var editAction = "editRunAlarm";
//删除权限
var delAction = "deleteRunAlarm";
...
function getAddForm(){
	...
	var bounceRunDistance = $("#bounceRunDistance").val();//运行距离(米)
	 ...
	 setParam.put("@bounceRunDistance",bounceRunDistance);
