...
//表名
var tableName = "ANA_AnalyserRoadExcursion";
//编辑权限
var editAction = "editAnalyseRoadExcursion";
//删除权限
var delAction = "deleteAnalyseRoadExcursion";
...
function getAddForm(){
	...
	var minExcursionValue = $("#minExcursionValue").val();//范围门限
	var bounceTime = $("#bounceTime").val();//时间门限
	 ...
	 setParam.put("@minExcursionValue",minExcursionValue);
