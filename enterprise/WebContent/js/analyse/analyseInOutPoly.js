...
//表名
var tableName = "ANA_AnalyserInOutPoly";
//编辑权限
var editAction = "editAnalyseInOutPoly";
//删除权限
var delAction = "deleteAnalyseInOutPoly";
...
function load(){
	...
	/**其它报警设置相同业务【指有时间类型业务更这个相同的】必须复制begin**/
		...
		//初始化区域选择框
		initAjaxSelect("placeTypeId","sys/getCustomArea.action",0);
...
function doCreate(){
	...
	if(canSubmit){
		...
		$.ajax({
		    type : "POST",
		    url : "analyse/insertAnalyseInOutPoly.action",
