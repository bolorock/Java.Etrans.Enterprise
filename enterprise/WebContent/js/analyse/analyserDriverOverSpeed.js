...
//表名
var tableName = "ANA_AnalyserDriverOverSpeed";
//编辑权限
var editAction = "editDriverOverSpeed";
//删除权限
var delAction = "deleteDriverOverSpeed";
...
function getAddForm(){
	...
	var bounceSpeed = $("#bounceSpeed").val();//速度门限(km/h)
