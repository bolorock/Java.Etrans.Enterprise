...
//表名
var tableName = "ANA2_AnalyserSpeedGZSJW";
//编辑权限
var editAction = "editSpeedGZSJW";
//删除权限
var delAction = "deleteSpeedGZSJW";
...
function getAddForm(){
	...
	var recordInterval = $("#recordInterval").val();//记录频率(秒)
	var lowerSpeed = $("#lowerSpeed").val();//速度>=(km/h)
	var upperSpeed = $("#upperSpeed").val();//速度<=(km/h)
	var lowerTime = $("#lowerTime").val();//时间>=(秒)
	var gpsMaxInterval = $("#gpsMaxInterval").val();//最大GPS间隔(秒)
	 ...
	 setParam.put("@recordInterval",recordInterval);
	 setParam.put("@lowerSpeed",lowerSpeed);
	 setParam.put("@upperSpeed",upperSpeed);
	 setParam.put("@lowerTime",lowerTime);
	 setParam.put("@gpsMaxInterval",gpsMaxInterval);
