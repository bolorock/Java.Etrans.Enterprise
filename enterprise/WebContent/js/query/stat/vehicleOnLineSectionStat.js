...
$(function() {
		...
		$("#findVehicleOnlineSectionList").flexigrid( {
...
//	$("#uplinePercentChart").hide();
	...
	// 重置表格的某些参数
	$("#findVehicleOnlineSectionList").flexOptions({
			newp : 1,// 设置起始页
...
function toExportExl() {
	exportExl('findVehicleOnlineSectionList', 'query/stat/VehicleOnlineSectionListExportExl.action');
}
