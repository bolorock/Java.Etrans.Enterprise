	...
	$.ajax({
		...
		$(data).each(function(i,n){
			try{
				...
				if(isOnline){
					uplineCount++;
					upLineVehicle+='<tr><td nowrap="nowrap"  align="center"><a  style="text-decoration:underline;font-size:12px"  onMouseOut="style.color=\'#000000\'"    onMouseMove="style.color=\'#0000FF\'" href=javascript:gotoVehicleInfo(\''+vehicleId+'\',\''+registrationNo+'\')>'+registrationNo+'</a></td><td nowrap="nowrap" align="center" style="font-size:12px">'+noColor+'</td><td nowrap="nowrap"  align="center" style="font-size:12px">'+workunitName+'</td></tr>';
				}else{
					downLineVehicle+='<tr><td nowrap="nowrap"  align="center"><a style="text-decoration:underline;font-size:12px" onMouseOut="style.color=\'#000000\'"    onMouseMove="style.color=\'#0000FF\'" href=javascript:gotoVehicleInfo(\''+vehicleId+'\',\''+registrationNo+'\')>'+registrationNo+'</td><td nowrap="nowrap" align="center" style="font-size:12px">'+noColor+'</td><td nowrap="nowrap"  align="center" style="font-size:12px">'+workunitName+'</td></tr>';
				} 
