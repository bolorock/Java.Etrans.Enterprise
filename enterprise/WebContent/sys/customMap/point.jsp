...
<script type="text/javascript" src="${basePath}js/sys/customMap/point.js"></script>
...
<body style="background-color: #fff;">
       <table sytle="font-size:12px;" width="175" height="98" border="0" cellpadding="0" cellspacing="1">
			    ...
			    <tr style="font-size:12px;">
			     ...
			     <tr style="font-size:12px;">
				  <td width="8">&nbsp;</td>
			      <td width="164"> 类型：<select id=type  style="width:120px;"></select></td>
			      
			    </tr>
			    <!--
			    <tr style="font-size:12px;">
				  <td>&nbsp;</td>
			      <td colspan="2"> 经度：<input id="longitude" name="longitude" size="14" readonly="readonly" /></td>
			    </tr>
			    <tr style="font-size:12px;">
				  <td>&nbsp;</td>
			      <td colspan="2"> 纬度：<input id="latitude" name="latitude" size="14" readonly="readonly" /></td>
			    </tr>
				-->
				<tr>
