...
<%--			      		 <input type="text" id="workUnitIdPram" readonly="readonly" class="mon_ser_text" style="width: 130;"/>--%>
<%--			      		 <a id="workBtn" href="javascript:void(0)" class="ser_btn" style="color: white;">请选择</a>--%>
<%--			      		 <input type="hidden" id="workUnitId" />--%>
                           <input type="text"  readonly="readonly"
						    id="workUnitIdPram" onclick="showWorkUnitTree()"
			...
			<div id="editWindow" class="wDiv" style="width:100%;display: none;border: 1px solid #d0d0d0;">
				<div class="td_title" id="titleInfo">SIM卡信息编辑</div>
				<table width="100%">
					<tr>
...
<%--								mobilephone="true" mobilephoneError="请输入有效电话号码！"--%>
						...
						<td align="left">
							<input type="text" name="code" id="code" class="td_input"  maxlength="11"
							    formCheck="true"  
					...
					<tr>
						...
						<td align="left">
							<input type="text" id="workUnitIDName"  formCheck="true"   class="td_input" 
...
<%--						</td>--%>
                           <input type="text" id="effectiveDate" name="effectiveDate" class="td_input" onFocus="this.blur()" readonly="readonly"  style="width:155px"/>
							<img src="Images/time.jpg" width="20" height="23" style="margin-left:2px;"
								onClick="WdatePicker({firstDayOfWeek:1,isShowWeek:true,el:document.getElementById('effectiveDate'),dateFmt:'yyyy-MM-dd'})"/>
							<span id="effectiveDatespan" class="errorMsg" style="display: none"></span>
					...
					<tr>
						...
						<img src="Images/time.jpg" width="20" height="23" style="margin-left:2px;"
							onClick="WdatePicker({firstDayOfWeek:1,isShowWeek:true,el:document.getElementById('endDate'),dateFmt:'yyyy-MM-dd'})"/>
						</td>
