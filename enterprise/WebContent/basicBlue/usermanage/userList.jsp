			              ...
			              <tr>
			               ...
			               <s:if test="'true' eq #request.isSuper">
			                    <td width="100" align="right"><span class="xin_red">*</span>用户类型：</td>
					                <td width="240" align="left">
					                    <input type="radio" name="IsSuperUser" value="0" checked="checked">普通管理员
						                <input type="radio" name="IsSuperUser" value="1">企业管理员
			              ...
			              <tr>
			                <td width="100" align="right"><span class="xin_red">*</span>用户状态：</td>
			                 	<td  width="150" align="left">
			                   		...
			                   		<input type="hidden" id="IsSuperInput" />
			               	 	</td>
			                 ...
			                 <tr>
			                 	...
			                 	<td  width="150" align="left">
			                  	...
			                  	<!--<s:if test="'true' eq #request.isSuper">
			                   		<td width="100" align="right"><span class="xin_red">*</span>用户类型：</td>
			                		<td width="240" align="left">
				                 		<input type="radio" name="IsSuperUser1" value="1" id="IsSuperInput">管理员
				                 		<input type="radio" name="IsSuperUser1" value="0" id="IsNotSuperInput">普通用户
			                		</td>
			                	</s:if>
			               		<s:else>
			               			<td></td><td></td>
