...
<script src="<%=basePath%>js/common/left.js" type="text/javascript"></script>
 ...
 <div id="cont_box">
	<div class="main">
    	<div class="left mon_meun">
		 ...
		 <!-- 轨迹分析管理 -->  
		  <s:action id="twoLevelMenu" name="getUserTwoMenusTA" namespace="/sys" >
		  	<s:param value="262" name="parentId"/>
		  </s:action>
			  <s:action id="threeLevelMenu" name="getUserThreeMenusTA" namespace="/sys" >
			  ...
			  <s:iterator value="#twoLevelMenu.userTwoLevelList" id="menu" status="twoLevelSta">
					...
					<script language="javascript">
				 	 ...
				 	 <dd><ul>
						<s:iterator value="#threeLevelMenu.userThreeLevelList" id="cm" status="threeLevelSta">
							<s:if test="#menu.functionId == #cm.parentFuncId">
								<li><a href="${pageContext.request.contextPath}${cm.assemblyName}" target="rightFrame">${cm.functionName }</a></li>
								<script language="javascript">
