...
<script type="text/javascript" src="${basePath}js/analyse/analyserLive.js"></script>
				...
				<table border="0" cellspacing="0" cellpadding="0" class="que_tab">
		           <tr>
		                ...
		                <td width="100">
		                	...
		                	<%--权限控制--%>
							<auth:authorize operation="addAnalyserLive">
      		...
      		<div id="editWindow" class="wDiv" style="display:none;border: 1px solid #d0d0d0;width: 100%;height:300px;overflow-y:auto;">
				   ...
				   <tr>
				      ...
				      <td width="200">
				       	<input type="text" name="name" id="name" class="td_input" maxlength="20"
				      			...
				      			ajaxAction="analyse/checkName_analyserLive.action"
								ajaxDataId="id">
				...
				<!--第二行-->
				 <tr>
			 	  ...
			 	  <td><select id="isAlert" class="td_sel" name="isAlert" >
		    	  </select>
		      	  </td>
			      <td align="right" class="td_te"><span class="xin_red">*</span>地点  ：</td>
			      <td>
			      	<select id="typeName" class="td_sel" name="typeName" formCheck="true" required="true" noselect="true" requiredError="请选择一项"> </select>
			    ...
			    <tr>
			      ...
			      <td>
			    	...
			    	<span id="checkTimeValuespan" class="errorMsg" style="display: none"></span>
			      </td>
			     </tr>
			    <!--第四行-->
			    <tr>
			    ...
			    <!--第五行-->
			    <tr>
			      <td align="right" class="td_te"><span class="xin_red">*</span>规定休息时长(分钟)：</td>
			      <td width="200">
			      	<input type="text" name="breakTimeLen" id="breakTimeLen" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
								>
								<span id="breakTimeLenspan" class="errorMsg" style="display: none"></span>
			      </td>
			      <td align="right" class="td_te"><span class="xin_red">*</span>范围门限(米) ：</td>
			      <td width="200">
			      		<input type="text" name="rangeValue" id="rangeValue" class="td_input" maxlength="8"
				      			formCheck="true"
				      			integer="true" integerError="请输入有效整数!"
				      			required="true" requiredError="必须输入项"  
								>
								<span id="rangeValuespan" class="errorMsg" style="display: none"></span>
			      </td>
			     </tr>
			     
			    <!--第六行-->
			    <tr>
			      <td align="right" class="td_te"><span class="xin_red">*</span>进入休息区语音 ：</td>
			      <td width="200">
			      	<input type="text" name="hintVoice" id="hintVoice" class="td_input" maxlength="100"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
								>
								<span id="hintVoicespan" class="errorMsg" style="display: none"></span>
			      </td>
			      <td align="right" class="td_te"><span class="xin_red">*</span>停车时间过短语音 ：</td>
			      <td width="200">
			      	<input type="text" name="coss" id="coss" class="td_input" maxlength="100"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
								>
								<span id="cossspan" class="errorMsg" style="display: none"></span>
			      </td>
			     </tr>
