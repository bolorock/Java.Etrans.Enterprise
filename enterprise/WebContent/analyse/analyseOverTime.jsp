...
<script type="text/javascript" src="${basePath}js/analyse/analyseOverTime.js"></script>
      		...
      		<div id="editWindow" class="wDiv" style="display:none;border: 1px solid #d0d0d0;width: 100%;height:300px;overflow-y:auto;">
				   ...
				   <tr>
				      ...
				      <td width="200">
				       	<input type="text" name="name" id="name" class="td_input" maxlength="20"
				      			...
				      			ajaxAction="analyse/checkName4Form.action?tableName=ANA_AnalyserOverTime" 
								ajaxDataId="id">
				...
				<!--第二行-->
				 <tr>
			      ...
			      <td align="right" class="td_te"><span class="xin_red">*</span>及时记录  ：</td>
			      <td>
			      	<select id="isWarn" class="td_sel" name="isWarn" >
			    	</select>
			      </td>
				 </tr>
				<!--第三行-->
			    ...
			    <!--第五行-->
			    <tr>
			      <td align="right" class="td_te"><span class="xin_red">*</span>疲劳距离(米) ：</td>
			      <td width="200">
			      	<input type="text" name="bounceOverDistance" id="bounceOverDistance" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
								>
								<span id="bounceOverDistancespan" class="errorMsg" style="display: none"></span>
			      </td>
			      <td align="right" class="td_te"><span class="xin_red">*</span>疲劳时间(秒) ：</td>
			      <td width="200">
			      		<input type="text" name="bounceOverTime" id="bounceOverTime" class="td_input" maxlength="8"
				      			formCheck="true"
				      			integer="true" integerError="请输入有效整数!"
				      			required="true" requiredError="必须输入项"  
								>
								<span id="bounceOverTimespan" class="errorMsg" style="display: none"></span>
			      </td>
			     </tr>
			     
			    <!--第六行-->
			    <tr>
			      <td align="right" class="td_te"><span class="xin_red">*</span>允许最长停车时间(秒) ：</td>
			      <td width="200">
			      	<input type="text" name="allowMaxStopTime" id="allowMaxStopTime" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
								>
								<span id="allowMaxStopTimespan" class="errorMsg" style="display: none"></span>
			      </td>
			      <td width="200">
			      </td>
			     </tr>
			    ...
			    <!--第七行-->
			    <tr>
			      <td align="right" class="td_te">播报内容 ：</td>
			      <td width="200" colspan="3">
			      	<input type="text" name="soundContent" id="soundContent"  style="width: 180px; border:1px solid #CCC; height:22px; line-height: 22px;" 
			      				formCheck="true"
			      				textLength="1-50" valLengthError="长度必须在100个字符内" 
								>
