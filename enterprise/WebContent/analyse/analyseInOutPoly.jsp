...
<script type="text/javascript" src="${basePath}js/analyse/analyseInOutPoly.js"></script>
				   ...
				   <tr>
				      ...
				      <td width="200">
				       	<input type="text" name="name" id="name" class="td_input" maxlength="20"
				      			...
				      			ajaxAction="analyse/checkName4Form.action?tableName=ANA_AnalyserInOutPoly" 
								ajaxDataId="id">
								<span id="namespan" class="errorMsg" style="display: none"></span>
				      </td>
				      <td align="right" class="td_te"><span class="xin_red">*</span>轨迹分析组：</td> 
				      <td >
				       		<select id="analyseGroupID" name="analyseGroupID" class="td_sel"></select>
				      </td>
				...
				<!--第二行-->
				 <tr>
			      ...
			      <td align="right" class="td_te"> <span class="xin_red">*</span>区域 ：</td>
			 	    <td><select id="placeTypeId" class="td_sel" name="placeTypeId" 
			 	     formCheck="true" required="true" noselect="true" requiredError="请选择一项"> </select>
