...
<script type="text/javascript" src="${basePath}js/analyse/AnalyserOverSpeedRoadCY.js"></script>
...
<div style="width: 100%" id="cont_box">
	<div class="main">
		<div class="mon_cont">
			<div class="E_Tit">道路超速报警设置(长运)</div>
				   ...
				   <tr>
				      ...
				      <td width="200">
				       	...
				       	<input type="text" name="name" id="name" class="td_input" maxlength="20"
				      			...
				      			ajaxAction="analyse/checkPointName.action" 
								ajaxDataId="id">
