...
<script type="text/javascript" src="${basePath}js/analyse/analyserDriverOverSpeed.js"></script>
...
<div style="width: 100%" id="cont_box">
	<div class="main">
		<div class="mon_cont">
			<div class="E_Tit">司机超速行驶报警设置</div>
				   ...
				   <tr>
				      ...
				      <td width="200">
				       	<input type="text" name="name" id="name" class="td_input" maxlength="20"
				      			...
				      			ajaxAction="analyse/checkName4Form.action?tableName=ANA_AnalyserDriverOverSpeed" 
								ajaxDataId="id">
				...
				<!--第二行-->
				 <tr>
			      ...
			      <td align="right" class="td_te"> <span class="xin_red">*</span>是否蜂鸣器报警  ：</td>
			 	  <td><select id="isWarn" class="td_sel" name="isWarn" >
		    	  </select>
		      	  </td>
				 </tr>
				<!--第三行-->
