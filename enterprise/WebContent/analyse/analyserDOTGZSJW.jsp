...
<script type="text/javascript" src="${basePath}js/analyse/analyserDOTGZSJW.js"></script>
...
<div style="width: 100%" id="cont_box">
	<div class="main">
		<div class="mon_cont">
			<div class="E_Tit">疲劳驾驶报警设置(交委)</div>
        	 ...
        	 <!-- 新增 或者编辑-->
      		<div id="editWindow" class="wDiv" style="display:none;border: 1px solid #d0d0d0;width: 100%;height:300px;overflow-y:auto;">
				   ...
				   <tr>
				      ...
				      <td width="200">
				       	<input type="text" name="name" id="name" class="td_input" maxlength="20"
				      			...
				      			ajaxAction="analyse/checkName4Form.action?tableName=ANA_AnalyserDOTGZSJW" 
								ajaxDataId="id">
				...
				<!--第二行-->
				 <tr>
				  ...
				  <tr>
				 	 ...
				 	 <td align="right" class="td_te"><span class="xin_red">*</span>预警门限(秒) ：</td>
			         <td width="200">
			      		<input type="text" name="earlyWarningLimit" id="earlyWarningLimit" class="td_input" maxlength="8"
				      			formCheck="true"
				      			integer="true" integerError="请输入有效整数!"
				      			required="true" requiredError="必须输入项" 
				      				textLength="1-8" valLengthError="长度为8位"  />
								<span id="earlyWarningLimitspan" class="errorMsg" style="display: none"></span>
			      </td>
				 ...
				 <tr>
		      	 ...
		      	 <td align="right" class="td_te"><span class="xin_red">*</span>最小有效休息时间(秒) ：</td>
			      <td width="200">
			      	<input type="text" name="minValidRestTime" id="minValidRestTime" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
				      			textLength="1-8" valLengthError="长度为8位" 
								>
								<span id="minValidRestTimespan" class="errorMsg" style="display: none"></span>
			      </td>
			    ...
			    <!--第五行-->
			    <tr>
			      <td align="right" class="td_te"><span class="xin_red">*</span>连续休息时间(秒) ：</td>
			      <td width="200">
			      	<input type="text" name="continuousRestTime" id="continuousRestTime" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
				      				textLength="1-8" valLengthError="长度为8位" 
								>
								<span id="continuousRestTimespan" class="errorMsg" style="display: none"></span>
			      </td>
			      <td align="right" class="td_te"><span class="xin_red">*</span>累计休息时间(秒) ：</td>
			      <td width="200">
			      		<input type="text" name="sumOfRestTime" id="sumOfRestTime" class="td_input" maxlength="8"
				      			formCheck="true"
				      			integer="true" integerError="请输入有效整数!"
				      			required="true" requiredError="必须输入项" 
				      			textLength="1-8" valLengthError="长度为8位"  
								>
								<span id="sumOfRestTimespan" class="errorMsg" style="display: none"></span>
			      </td>
			     </tr>
			     
			    <!--第六行-->
			    <tr>
			      <td align="right" class="td_te"><span class="xin_red">*</span>疲劳驾驶临界时间(秒) ：</td>
			      <td width="200">
			      	<input type="text" name="drivingOverTime" id="drivingOverTime" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
				      			textLength="1-8" valLengthError="长度为8位" 
								>
								<span id="drivingOverTimespan" class="errorMsg" style="display: none"></span>
			      </td>
			       <td align="right" class="td_te"><span class="xin_red">*</span>最小判断距离(公里) ：</td>
			      <td width="200">
			      	<input type="text" name="drivingMinMileage" id="drivingMinMileage" class="td_input" maxlength="8"
				      			formCheck="true"
				      			required="true" requiredError="必须输入项"  
				      			integer="true" integerError="请输入有效整数!"
				      			textLength="1-8" valLengthError="长度为8位" 
								>
								<span id="drivingMinMileagespan" class="errorMsg" style="display: none"></span>
			      </td>
			     </tr>
			      <!--第六行-->
			    <tr>
