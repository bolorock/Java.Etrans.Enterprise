...
<html>
	<head>
		...
		<script src="<%=basePath%>js/command/batch/special/507.js" type="text/javascript"></script>
	</head>
	 ...
	 <table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
			  <td width="100%" align="center">
				   <fieldset style="border-Color:#80CAEA;width: 98%;"><legend>事件设置：指令参数</legend>
                    	  ...
                    	  <option value="0">删除终端现有事件</option>
                    	  <option value="1">更新事件</option>
                    	  <option value="2">追加事件</option>
                          <option value="3">修改事件</option>
                          <option value="4">删除特定几项事件</option>
                    	 </select>
                    	  </td></tr>
                    	   <tr>
                   <td width="60px" style="visibility: hidden;" id="eventCountId">事件总数</td>
                   <td  width="30px"><input id="eventCount" style="visibility: hidden;"></input></td>
                   <td  width="30px"><input id="okButon" type="button" value="确定" style="visibility: hidden;" onclick="addEvent()"/></td>
                   <td>&nbsp;</td>
                  </tr>
				              </table></td>
