...
<html>
	...
	<base href="<%=basePath%>"></base>
		...
		<script src="<%=basePath%>js/command/batch/special/376.js" type="text/javascript"></script>
	 ...
	 <table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
			  <td width="100%" align="center">
				  <fieldset style="border-Color:#80CAEA;width: 98%;"><legend>设置矩形区域：指令参数</legend>
				  		<table width="100%" cellpadding="0" cellspacing="1">
				            ...
				            <tr>
				              ...
				              <td width="269" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
				                <tr>
				                  ...
				                  <td valign="top" nowrap="nowrap">
								  	 <select name="param1" id="param1" paramScale="16" paramLength="1">
				              ...
				              <td width="16" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
                                  <td height="25" nowrap="nowrap"><div align="right">选择矩形区域：</div></td>
				                  <td valign="top" nowrap="nowrap">
				                   <div align="left">
                                ...
                                <tr>
                                  <td height="25" nowrap="nowrap"><div align="right">左上点纬度：</div></td>
                                ...
                                <tr>
                                  <td height="25" nowrap="nowrap"><div align="right">左上点经度：</div></td>
                                  <td colspan="2" valign="middle" nowrap="nowrap"><div align="left">
                                    <div align="left">
                                      <input name="param3-2" 
											   id="param3-2" 
                                ...
                                <tr>
                                  <td height="25" nowrap="nowrap"><div align="right">右下点纬度：</div></td>
                                  <td colspan="2" valign="middle" nowrap="nowrap"><div align="left">
                                    <div align="left">
                                      <input name="param3-3" 
											   id="param3-3" 
                                ...
                                <tr>
                                  <td height="25" nowrap="nowrap"><div align="right">右下点经度：</div></td>
                                  <td colspan="2" valign="middle" nowrap="nowrap"><div align="left">
                                    <div align="left">
                                      <input name="param3-4" 
											   id="param3-4" 
                                ...
                                <tr>
                                  ...
                                  <td valign="bottom" nowrap="nowrap"><div align="left"><input id="param4" name="param4" size="15"  width="140" maxlength="12"  style="height: 20px;font-size: 12px;"/>
                                  </div></td>
                                ...
                                <tr>
                                  ...
                                  <td valign="bottom" nowrap="nowrap"><div align="left"><input id="param5" name="param5" size="15" class="input" maxlength="12" style="height: 20px;font-size: 12px;"/>
                                  </div></td>
