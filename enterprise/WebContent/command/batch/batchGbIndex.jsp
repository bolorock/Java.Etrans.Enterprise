...
<html>
	...
	<base href="<%=basePath%>"></base>
      ...
      <script type="text/javascript" src="<%=basePath%>js/command/batch/batchGbIndex.js"></script>
	...
	<input type="hidden" id="commandId" name="commandId" value=""/>
	 ...
	 <table width="100%" cellpadding="0" cellspacing="0" border="0">
			  ...
			  <td width="100%" align="center">
				  <fieldset style="border-Color:#80CAEA;width: 100%;"><legend><span id="commandName"></span></legend>
				  		<table width="100%" cellpadding="0" border="0" cellspacing="1">
				            ...
				            <tr>
				              <td width="3">&nbsp;</td>
				              <td width="700"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody id="tabInfo"></tbody></table></td>
				              <td width="16">&nbsp;</td>
				              <td width="13">&nbsp;</td>  
				            </tr>
							<tr>
		 ...
		 <tr>
		 <td valign="top"><a href="javascript:void(0)" onClick="sendMessage();"><img src="imgs/command.gif"  border="0"></a><a  href="javascript:void(0)" class="ser_btn" onClick="parent.hide();"><img src="imgs/cancel.gif"  border="0"></a>
	   </td>
		 </tr>
		</table>
		<div align="left">
