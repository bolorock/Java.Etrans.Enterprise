...
<html>
<head>
        <title>企业车辆在线统计</title>
        <script  type="text/javascript" src="${basePath}js/datepicker/WdatePicker.js"></script>
	    <script type="text/javascript" src="${basePath}js/query/stat/vehicleOnLineSectionStat.js"></script>
	              ...
	              <tr>
	                 <td width="80" align="right">企业名称:</td>
		                ...
		                <input id="workUnitNameParam" ondblclick="showWorkUnitTree()" type="text"  class="mon_ser_text" style="width: 130;"
		                		maxlength="30"   name="workUnitName"
...
<!--		             <a id="showBtn" href="javascript:void(0)" class="ser_btn" style="color: white;">图表</a>-->
          ...
          <div id="findVehicleOnlineSection">
               <table id="findVehicleOnlineSectionList" style="display: none"></table>
          </div> 
