...
<html>
<head>
        <title>企业车辆油量统计</title>
	    <script type="text/javascript" src="${basePath}js/query/stat/workUnitOilInfo.js"></script>
...
<div id="cont_box">
	<div class="main">
        <div class="mon_cont">
          ...
          <div>
               <table id="findWorkUnitOilInfoList" style="display: none"></table>
          </div> 
      </div>
</div>
</div>
