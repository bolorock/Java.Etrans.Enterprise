...
<head>
	    ...
	    <script type="text/javascript" src="${basePath}js/query/stat/vehicleOnlinePercert_mysql.js"></script>
...
<div id="cont_box">
	<div class="main">
        <div class="mon_cont">
          ...
          <div><table id="vehicleOnlinePercertList_mysql" style="display: none"></table></div> 
    </div>
</div>
</div>
