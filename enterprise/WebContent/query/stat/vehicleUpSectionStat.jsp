...
<html>
<head>
        <title>企业车辆上线统计</title>
        <script  type="text/javascript" src="${basePath}js/datepicker/WdatePicker.js"></script>
	    <script type="text/javascript" src="${basePath}js/query/stat/vehicleSectionUpLineStat.js"></script>
...
<!--		             <a id="showBtn" href="javascript:void(0)" class="ser_btn" style="color: white;">图表</a>-->
          ...
          <div id="findVehicleSectionUpline">
               <table id="findVehicleSectionUplineList" style="display: none"></table>
          </div> 
