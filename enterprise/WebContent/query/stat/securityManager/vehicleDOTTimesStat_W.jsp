...
<html>
<head>
        <title>企业车辆疲劳驾驶统计</title>
        <script  type="text/javascript" src="${basePath}js/datepicker/WdatePicker.js"></script>
        <%--页面抽取js--%>
	    <script type="text/javascript" src="${basePath}js/query/stat/securityManager/vehicleDOTTimesStat_W.js"></script>
		<%--时间帮助js--%>
...
<div id="cont_box">
	<div class="main">
        <div class="mon_cont">
        	<div class="E_Tit">企业车辆疲劳驾驶统计</div>
        	   <table border="0" cellspacing="0" cellpadding="0" class="que_tab">
	              <tr>
	                 <td width="80" align="right">企业名称:</td>
		                <td width="130" align="left">
		               <input id="workUnitNameParam" ondblclick="showWorkUnitTree()" name="workUnitName" type="text"  class="mon_ser_text" style="width: 130;"
		                		maxlength="30" 
...
<!--		             <a id="showBtn" href="javascript:void(0)" class="ser_btn" style="color: white;">图表</a>-->
		  ...
		  <%--列表--%>
          <div id="findVehicleDOTTimesStat">
               <table id="findVehicleDOTTimesStatList" style="display: none"></table>
          </div> 
