...
<head>
	    ...
	    <script type="text/javascript" src="${basePath}js/query/stat/vehicleSpeedStat.js"></script>
...
<!--		             <a id="showBtn" href="javascript:void(0)" class="ser_btn" style="color: white;">图表</a>-->
          ...
          <div id="findVehicleSpeed">
               <table id="findVehicleSpeedList" style="display: none"></table>
          </div> 
