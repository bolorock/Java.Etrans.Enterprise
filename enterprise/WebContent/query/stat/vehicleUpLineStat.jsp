...
<head>
	    ...
	    <script type="text/javascript" src="${basePath}js/query/stat/vehicleUpLineStat.js"></script>
...
<!--		             <a style="display: none;" id="adSearchBtn" href="javascript:void(0)"   style="margin-left:8px;">高级搜索</a></td>-->
          ...
          <div id="findVehicleUpline">
               <table id="findVehicleUplineList" style="display: none"></table>
          </div> 
