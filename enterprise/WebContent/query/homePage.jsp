	...
	<div class="main">
        ...
        <div class="left M_box i_w_01"  id="tabInfo"> 
            ...
            <div class="right M_box i_w_03">
            	...
            	<div><iframe src="<%=basePath%>query/homePageIframe.jsp" id="charFrame" width="355px" height="195px" style="overflow:hidden; " marginwidth="0"  marginheight="0" frameborder="0"></iframe></div>
            </div>
